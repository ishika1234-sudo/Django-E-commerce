...
class VariationManager(models.Manager): # to seperate the variations 
    def colors(self):
...
class Variation(models.Model):
    ...
    variation_category = models.CharField(max_length=100, choices=variation_category_choice) # choices will create dropdown in admin panel
